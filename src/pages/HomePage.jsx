    ...
    <>
      ...
      <section className="w-full relative overflow-hidden tap-clear">
        ...
        <button
          ...
          className="relative block w-full cursor-pointer -mt-[clamp(2rem,12svh,10rem)] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-white/60"
        >
          <picture>
            <source
